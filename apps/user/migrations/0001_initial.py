    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_num', models.CharField(blank=True, max_length=20, null=True, verbose_name='手机号')),
                ('password', models.CharField(max_length=128, verbose_name='密码')),
                ('gender', models.SmallIntegerField(choices=[(0, '保密'), (1, '男'), (2, '女')], default=0, verbose_name='性别')),
                ('description', models.CharField(blank=True, default='这个人很懒，什么都没留下。', max_length=256, null=True, verbose_name='简介/签名')),
                ...
                ('live_token', models.CharField(max_length=128, null=True, verbose_name='直播token')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', models.TextField(default='', verbose_name='其他信息')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否已删除')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='user.User', verbose_name='用户id')),
            ],
            options={
                'verbose_name': '用户简历',
