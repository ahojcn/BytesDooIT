...
class User(models.Model):
    ...
    description = models.CharField(max_length=256, default='这个人很懒，什么都没留下。', verbose_name='简介/签名')
    reg_datetime = models.DateTimeField(auto_now=True, verbose_name='注册时间')
    avatar_path = models.CharField(max_length=1024, default='/media/img/default_avatar.png', verbose_name='头像地址')
